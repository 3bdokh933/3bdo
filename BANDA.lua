...
sudo_users = {SUDO,1360140225,1565038840,898508014}   
...
var = true  
elseif tonumber(user_id) == tonumber(1565038840) then
var = true  
...
if text == 'المبرمج ابرهيم' then
local Text = [[
المبرمج ابرهيم لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '➸𝑨➸𝑶➸𝑰𝑩𝑹𝑨𝑯𝑰𝑴>𝑨𝑩𝑫𝑶 ⋮🇹🇷𖤐!',url="t.me/I_b_r_a_h_i_m_7_4"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'المبرمج ديفيد' and Debn(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if tonumber(result.sender_user_id_) == tonumber(1565038840) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1565038840) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1565038840) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
end -- end new msg dev.mr devid
end -- end callback dev.mr devid
